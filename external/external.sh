...
supported_tests="external_custom aot camel criu-functional criu-portable-checkpoint  criu-portable-restore criu-ubi-portable-checkpoint criu-ubi-portable-restore daytrader_CreateRestoreImageAndPushToRegistry_ubi9 daytrader_pullImageUnprivilegedRestore_ubi9 daytrader_testCreateImageAndPrivilegedRestore_ubi9 derby elasticsearch jacoco jenkins functional-test kafka lucene-solr openliberty-mp-tck payara-mp-tck quarkus quarkus_quickstarts scala system-test tck-ubi-test tomcat tomee wildfly wycheproof netty spring"
